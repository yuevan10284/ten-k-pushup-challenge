...
export default function Home() {
  ...
  // expiry and no server-side identity check on log/message submission.
  // Without a visible "not you?" escape hatch, a shared device silently
  // attributes reps to the wrong person with no error at any layer.
  function switchAccount() {localStorage.removeItem("pushup-profile");setProfile(null);setLogs([]);setStartedAt(null);setName("");setPin("");setMessage("");setJoinOpen(true);}
