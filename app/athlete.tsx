...
export default function Athlete({id,onClose,baseTargets}:{id:number|null;onClose:()=>void;baseTargets:number[]}) {
  const [data,setData]=useState<{person:{name:string};logs:{day:number;count:number}[]}|null>(null);
